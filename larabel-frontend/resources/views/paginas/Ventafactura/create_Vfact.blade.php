...
<div class='container_p'>
    ...
    <div class='container_frm' >
        ...
        <form action="{{ route('Ventafactura.store') }}" method="get">

            <div class='cont_data_fm'>
                <label class='stl_labels' for="id_cliente">id_cliente</label>
                <input class='stl_inputs' type="text" name='id_cliente'  require>
            </div>

            <div class='cont_data_fm'>
                <label class='stl_labels' for="id_personal">id_personal</label>
                <input class='stl_inputs' type="text" name='id_personal'  require>
            </div>

            <div class='cont_data_fm'>
                <label class='stl_labels' for="estado">estado</label>
                <input class='stl_inputs' type="number" name='estado'  require>
            </div>

            <div class='cont_data_fm'>
                <label class='stl_labels' for="detalleproducto">detalleproducto</label>
                <input class='stl_inputs' type="text" name='detalleproducto'  require>
            </div>

            <div class='cont_data_fm'>
                <label class='stl_labels' for="fecha_venta">fecha_venta</label>
                <input class='stl_inputs' type="date" name='fecha_venta'  require>
            </div>
