    ...
    <div class='container_frm' >
        ...
        <form action="{{ route('products.store') }}" method="get">
            ...
            <div class='cont_data_fm'>
                ...
                <input class='stl_inputs' type="text" name='p_Categoria'  require>
            </div>

            <div class='cont_data_fm'>
                <label class='stl_labels' for="p_Nombre">Nombre</label>
                <input class='stl_inputs' type="text" name='p_Nombre'  require>
            </div>

            <div class='cont_data_fm'>
                <label class='stl_labels' for="p_Stock">Stock</label>
                <input class='stl_inputs' type="number" name='p_Stock'  require>
            </div>

            <div class='cont_data_fm'>
                <label class='stl_labels' for="p_Descripcion">Descripcion</label>
                <input class='stl_inputs' type="text" name='p_Descripcion'  require>
            </div>

            <div class='cont_data_fm'>
                <label class='stl_labels' for="p_Imagen">Imagen</label>
                <input class='stl_inputs' type="text" name='p_Imagen'  require>
            </div>

            <div class='cont_data_fm'>
                <label class='stl_labels' for="p_Estado">Estado</label>
                <input class='stl_inputs' type="text" name='p_Estado'  require>
            </div>
